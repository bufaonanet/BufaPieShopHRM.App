...
namespace BufaPieShopHRM.Api.Migrations
{
    ...
    [Migration("20230504175206_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BufaPieShopHRM.Shared.Domain.Country", b =>
                {
            ...
            modelBuilder.Entity("BufaPieShopHRM.Shared.Domain.Employee", b =>
                {
            ...
            modelBuilder.Entity("BufaPieShopHRM.Shared.Domain.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BufaPieShopHRM.Shared.Domain.Employee", b =>
                {
                    b.HasOne("BufaPieShopHRM.Shared.Domain.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BufaPieShopHRM.Shared.Domain.JobCategory", "JobCategory")
                        .WithMany()
